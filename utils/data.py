...
def available_models():
    ...
    lang_model_list_dict = {
        "none":[],
        "en":{
            "en_vctkVits":{"path":"tts_models/en/vctk/vits"},
            "en_ljspeechGlowtts":{"path":"tts_models/en/ljspeech/glow-tts"},
            "en_ljspeechFastPitch":{"path":"tts_models/en/ljspeech/fast_pitch"},
            "multi_xttsV2":{"path":"tts_models/multilingual/multi-dataset/xtts_v2"},
            },
        "de":{
            "de_thorstenVits":{"path":"tts_models/de/thorsten/vits"},
            "de_fairseqVits":{"path":"tts_models/deu/fairseq/vits"},
            "multi_xttsV2":{"path":"tts_models/multilingual/multi-dataset/xtts_v2"},
            },
        }
    
    all_model_list_dict = {}
    for lang,models in lang_model_list_dict.items():
        all_model_list_dict.update(models)
        for model_i_name,data in all_model_list_dict.items():
            all_model_list_dict[model_i_name]["name"] = model_i_name
            all_model_list_dict[model_i_name]["lang"] = lang
    
    return lang_model_list_dict, all_model_list_dict
